...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕SS  SS▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94MABKHANX3XWATY.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mABKHANX3XWATY\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : AB KHAN X3 XWATY 
\033[1;92m☞ WhatsApp   : 034******04
\033[1;95m☞ Facebook Page    : https://www.facebook.com/profile.php?id=100086667518973
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('https://www.facebook.com/profile.php?id=100086667518973')
		    menu()
		else:
...
def menu():
	...
	cb()
	print (logo)
	print (S + '[☆] ' + S + 'ID Name: ' + S + S['name'])
	print (S + '[☆] ' + S+ 'User ID: ' +S + S['id'])
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' Fast Cloning New Update')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update DUKABAX_XWATY Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' DUKABAX_XWATY WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/DUKABAX_XWATY')
	    os.system('cd $HOME && git clone https://github.com/abkhanx3xwaty/XwaTy')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 034@@@@@@04✓')
	    psb('WellCome To DUKABAX_XWATY')
	    psb('Congratulations DUKABAX_XWATY Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ DUKABAX✓')
	    psb('🔓Password ☆ XWATY✓')
	    psb('FOLLOW MY PAGE SWATI KII TRICKS✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/DUKABAX_XWATY && python2 B4.py')
	elif bm =='3':
	    os.system
')
	    menu()
